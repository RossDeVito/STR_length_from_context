...
OUTPUT_DIR="scripts/ig_kmers/output/enrichment"
CONFIG_DIR="scripts/ig_kmers/enrichment_configs"
...
echo "Running kmer enrichment with config: $CONFIG_FILE"
...
# Run the command
python -m kmer_analysis.kmer_enrichment \
